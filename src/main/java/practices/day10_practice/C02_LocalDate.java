...
public class C02_LocalDate {
    public static void main(String[] args) {
        ...
        LocalDate dogAli = LocalDate.of(1923,10,29).plusYears(45).plusMonths(8)
                .plusDays(5);//45 yil ekledik
        System.out.println(dogAli);

        LocalDate dogVeli = LocalDate.of(1993,9,15).minusYears(24).minusMonths(2)
                .minusDays(11);
