...
public class C04_ifElse {
    public static void main(String[] args) {
        ...
        İlk kelimenin karakter sayısı tek ise, konsola "ilk kelimenin ortasina ikinci kelimeyi koyamazsin
        cunku ilk kelime tek karakterli" yazdırın.
        */
        ...
        if (ilkKelime.length() % 2 == 0) {
            ...
            System.out.println("ilk kelimenin ortasina ikinci kelimeyi koyamazsin cunku ilke kelime tek karekterli ....");
        }
    }
}
